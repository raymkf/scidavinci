...
class PlotDatasetTool(Tool):
    ...
    def description(self) -> str:
        return (
            ...
            "once with the single best chart type, then copy the returned "
            "```chart-json block verbatim into the final assistant message. "
            "Do not create additional charts unless the user explicitly asks "
            "for multiple alternatives or a dashboard. "
